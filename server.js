  ...
  try {
    ...
    if (update.callback_query) {
      ...
      if (data.startsWith("order_received_")) {
        ...
        await sendMessage(chatId, "🎉 እናመሰግናለን! እቃው እንደደረሰዎት ተረጋግጦ ኦርደሩ ተዘግቷል። ❤️");
        return;
      }
      ...
      if (data.startsWith("qty_")) {
        ...
        if (!session) {
          await sendMessage(chatId, "❌ ክፍለ ጊዜው (Session) አብቅቷል። እባክዎ እንደገና /start ይበሉ።");
          return;
        }
      ...
      if (data === "order_confirm") {
        ...
        if (!session || !session.product) {
          await sendMessage(chatId, "❌ የኦርደር መረጃ አልተገኘም። እባክዎ እንደገና ይጀምሩ።");
          return;
        }
    ...
    if (message.photo && message.photo.length) {
      ...
      if (!order) {
        await sendMessage(chatId, "❌ ንቁ የክፍያ ኦርደር አልተገኘም። እባክዎ መጀመሪያ ከካታሎግ ውስጥ እቃ ይምረጡ።");
        return;
      }
    ...
    if (textMessage === "/start" || textMessage.startsWith("/start ")) {
      ...
      await sendMessage(chatId, "🛒 እንኳን ወደ <b>UNI MARKET</b> በደህና መጡ! ምርቶችን ለማየት ከታች ያለውን ቁልፍ ይጫኑ።", {
        parse_mode: "HTML",
